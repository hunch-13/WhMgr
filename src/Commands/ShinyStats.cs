namespace WhMgr.Commands
{
    ...
    public class ShinyStats : BaseCommandModule
    {
        ...
        public ShinyStats(WhConfigHolder whConfig, SubscriptionProcessor subProcessor)
        {
            _whConfig = whConfig;
        ...
        public async Task GetShinyStatsAsync(CommandContext ctx)
        {
            ...
            var stats = await GetShinyStats(_whConfig.Instance.Database.Scanner.ToString());
